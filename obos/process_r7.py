...
def compress_image_aggressive(image_path):
    """Aggressively compress image for Azure"""
    ...
    compressed_path = image_path + ".temp.jpg"
...
def process_r7():
    ...
    processed_path = compress_image_aggressive(market_img)
