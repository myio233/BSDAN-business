...
def build_campaign_state(
    *,
    ...
    return CampaignState(
        ...
        last_round_id=None,
        last_worker_salary=float(context["worker_salary_actual"]),
        last_engineer_salary=float(context["engineer_salary_actual"]),
    )
...
def next_campaign_state(
    *,
    ...
    return CampaignState(
        ...
        last_worker_salary=float(decision.worker_salary),
        last_engineer_salary=float(decision.engineer_salary),
    )
