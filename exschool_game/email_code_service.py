...
SMTP_FROM_NAME = os.environ.get("SMTP_FROM_NAME", "bsdan.ye97.cn").strip() or "bsdan.ye97.cn"
...
MAIL_SITE_NAME = os.environ.get("EXSCHOOL_AUTH_SITE_NAME", "bsdan.ye97.cn").strip() or "bsdan.ye97.cn"
